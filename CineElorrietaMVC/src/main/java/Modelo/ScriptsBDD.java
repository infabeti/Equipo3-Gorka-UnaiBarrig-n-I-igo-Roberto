...
public class ScriptsBDD {
	...
	public void insertarProductosElegidosTicket() throws SQLException {
		...
		PreparedStatement ntrans = conexionbd.prepareStatement("insert into contenido (NTrans,Codigo,Cantidad,PVP) " + " values((select count(NTrans) from transaccion),\""+productoTicket[i].getCodigoProducto()+"\",\""+productoTicket[i].getCantidad()+"\",\""+productoTicket[i].getPrecio()+"\")");
	...
	public void insertarProductosElegidosPedido() throws SQLException {
		...
		PreparedStatement ntrans = conexionbd.prepareStatement("insert into contenido (NTrans,Codigo,Cantidad,PVP) " + " values((select count(NTrans) from transaccion),\""+productoPedido[i].getCodigoProducto()+"\",\""+productoPedido[i].getCantidad()+"\",\""+productoPedido[i].getPrecio()+"\")");
		ntrans.executeUpdate();
		}
